    ...
    function Constant() {
        ...
        return {
            ...
            validateFileSize: function (file) {
                ...
                // alert(fileSize);
                if (fileSize >this.FileUploadConstants().Size) {
                    alert('File size exceeds ' +this.FileUploadConstants().Size + ' MiB');
                    return false;
            ...
            FileUploadConstants: function () {
                return {
                    "Formats": '.jpg,.gif,.png,.mp4,pdf',
                    "FormatsMsg": '.jpg / .gif / .png / .mp4 /pdf ',
                    "Size": 25 // in  mb
