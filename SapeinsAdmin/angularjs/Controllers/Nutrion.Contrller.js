...
app.controller('NutrionController', function ($scope, HTTP, api, Constant, $rootScope) {
  ...
  function init(HTTP) {
    ...
    $scope.SelectedUser = $scope.users.Nutritionist;
  ...
  $scope.UserObj = {
    "UserID": null,
    "Name": null,
    "UserTypeID": $scope.users.Nutritionist,
    "SpecialityID": null,
    "Experience": null,
